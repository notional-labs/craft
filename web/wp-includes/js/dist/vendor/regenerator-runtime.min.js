var runtime = function(a) {
    ...
    function c(t, r, e, n) {
        var o, i, a, c, r = r && r.prototype instanceof v ? r : v,
        ...
        return r._invoke = (o = t, i = e, a = n, c = l, function(t, r) {
            ...
            for (a.method = t, a.arg = r;;) {
                    ...
                    var n = function t(r, e) {
                        ...
                        if (n === u) {
                            if (e.delegate = null, "throw" === e.method) {
                                if (r.iterator.return && (e.method = "return", e.arg = u, t(r, e), "throw" === e.method)) return g;
                        ...
                        n = n.arg;
                        if (!n) return e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, g; {
                            if (!n.done) return n;
                ...
                n = f(o, i, a);
                if ("normal" === n.type) {
                    if (c = a.done ? y : s, n.arg !== g) return {
                        value: n.arg,
                        done: a.done
                    }
    ...
    return i(L, "constructor", d.prototype = m), i(m, "constructor", d), d.displayName = i(m, o, "GeneratorFunction"), a.isGeneratorFunction = function(t) {
    ...
    }, x(b.prototype), i(b.prototype, e, function() {
        return this
