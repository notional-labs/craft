...
FOLDER = "gentx" # accounts we will ONLY give balances too from the past submission
...
def createGenesisAccountsCommands():
    ...
    if not os.path.exists(FOLDER):
        print(f"# {FOLDER} not found. Did you run the script from the correct directory?")
        print(f"# cd networks/{CHAIN_ID}")
