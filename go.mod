...
require (
	github.com/cosmos/cosmos-sdk v0.46.0-alpha2.0.20220215175622-7869d38e94d5
...
replace (
	...
	github.com/cosmos/ibc-go => github.com/notional-labs/ibc-go/v3 v3.0.0-20220219033251-120278477073
